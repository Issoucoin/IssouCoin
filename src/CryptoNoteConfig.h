00000// Copyright (c) 2011-2016 The Cryptonote developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = (0x23fa);
...
const char     CRYPTONOTE_NAME[]                             = "IssouCoin";
...
const int      P2P_DEFAULT_PORT                              = 1825;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 5281;
